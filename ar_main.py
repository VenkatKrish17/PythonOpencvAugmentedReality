...
sys.path.append("E:/STUDIES/IW/Sure_FINAL/model/model1")
...
def main():
    ...
    obj = OBJ(os.path.join('model/model1/OBJ.obj'),with_gl=False, swapyz=True)
    # init video capture
    ...
    while True:
        ...
        if(len(models)==0):
            ...
            model1=cv2.imread("references/ref1/1.jpeg",0)
            model2=cv2.imread("references/ref1/2.jpeg",0)
            model3=cv2.imread("references/ref1/3.jpeg",0)
        ...
        if len(matches) > MIN_MATCHES:
            ...
            for mod_len in range(1,2):
                path='model/model'+str(mod_len)
                print(mod_len)
                sys.path.append("E:/STUDIES/IW/Sure_FINAL/model/model"+str(mod_len))

                print(sys.path)
                #display("../model/model"+str(mod_len)+"/OBJ.obj")
                os.system("python visualizer.py "+'model/model'+str(mod_len)+"/OBJ.obj")
                # sys.path.append('../model/model2')
